...
//import com.yonyou.sns.im.ui.fragment.ChatActivity;
//
...
//		boolean vibraNotify = BaseApplication.instance().getPreference()
//				.getBoolean(YMConfigConstants.NOTIFY_VIBRATION, true);
//		if (vibraNotify) {
...
//		String title = author;
//		String ticker;
//		boolean isTicker = BaseApplication.instance().getPreference()
//				.getBoolean(YMConfigConstants.NOTIFY_PREVIEW, true);
//		if (isTicker) {
...
//		PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, chatIntent, PendingIntent.FLAG_UPDATE_CURRENT);
//
...
//		boolean isLEDNotify = BaseApplication.instance().getPreference()
//				.getBoolean(YMConfigConstants.NOTIFY_REMIND, true);
//		if (isLEDNotify) {
