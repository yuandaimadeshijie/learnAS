...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int dividerColor = 0xFFe8e6e6;
	...
	private int tabTextColor = 0xFF909597;
	private int tabTextColorhl = 0xFF18C0ed;
	private Typeface tabTypeface = null;
	private int tabTypefaceStyle = Typeface.BOLD;

	private int lastScrollX = 0;

	private int tabBackgroundResId = R.drawable.selector_emoji_background_tab;
	...
	/**
	 * 
	 * 根据page的adapter初始化page界面（图标或者文字两种选择）
	 * 
	 */
	...
	/**
	 * 添加标签样式并设置事件，如果被点击了，viewpage需要重新设置页面值
	 * 
	 * @param position
	 * @param tab
	 */
		...
		for (int i = 0; i < tabCount; i++) {
			...
			if (v instanceof TextView) {
				...
				if (i == pager.getCurrentItem()) {
					tab.setTextColor(tabTextColorhl);
				} else {
	...
	/**
	 * 滑动条根据指定位置滑动(目前可能还没有用上，如果子内容大于水平滚动的长度，就应该会滑动)
	 * 
	 * @param position
	 * @param offset
	 */
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			for (int a = 0; a < tabsContainer.getChildCount(); a++) {
				...
				View view = tabsContainer.getChildAt(a);
				if (view instanceof TextView) {
					TextView title = (TextView) view;
					if (a == position) {
						title.setTextColor(tabTextColorhl);
					} else {
	...
	public void setIndicatorPadding(int indicatorPadding) {
		this.indicatorPadding = DensityUtils.dipTopx(getContext(), indicatorPadding);
		invalidate();
	}
	...
	public void setTexthlColor(int textColor) {
		this.tabTextColorhl = textColor;
	}
