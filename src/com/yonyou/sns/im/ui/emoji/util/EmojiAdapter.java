...
public class EmojiAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			rowView = mLayoutInflater.inflate(R.layout.emoji_cell, parent, false);
		...
		int count = getCount() * mCurrentPage + position;
		if (count < mFaceMap.size()) {
			int resId = mContext.getResources().getIdentifier(EmojiUtil.STATIC_FACE_PREFIX + mEmojiValues.get(count),
